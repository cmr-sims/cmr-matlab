function gaparam = ga_param_srch4
% gaparam = ga_param_srch4;
% 
...
gaparam(14).name = 'eye_cf';
gaparam(14).range = [0 1.0];
gaparam(14).vector_index = 14;

gaparam(15).name = 'taskShiftDisrupt';
gaparam(15).range = [0 0.95];
gaparam(15).vector_index = 15;

gaparam(16).name = 'tau';
gaparam(16).range = [100 1000];
gaparam(16).vector_index = 16;
