function gaparam = ga_param_co1
% gaparam = ga_param_co1;
% 
...
gaparam(9).name = 'K';
gaparam(9).range = [0 0.3];
gaparam(9).vector_index = 8;

gaparam(10).name = 'L';
gaparam(10).range = [0 1];
...
gaparam(16).name = 'final_boost';
gaparam(16).range = [0 1];
gaparam(16).vector_index = 15;

gaparam(17).name = 'lmod';
gaparam(17).range = [0 1];
gaparam(17).vector_index = 16;

gaparam(18).name = 'bmod';
gaparam(18).range = [0 0.5];
gaparam(18).vector_index = 17;

gaparam(19).name = 'eVthresh';
gaparam(19).range = [0 1];
gaparam(19).vector_index = 18;
